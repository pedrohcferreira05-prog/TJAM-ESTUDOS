...
export const PerfilView: React.FC<PerfilViewProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="p-5 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-emerald-950/40 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 mt-0.5">
              Eduardo e Pedro formam dupla oficial de estudos e estão no ranking geral TJAM 2026 em 5º lugar (30,0%). Todas as atividades concluídas sem pendências.
            </p>
          </div>
        </div>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-1.5">
                  <span className="text-[11px] text-emerald-300 font-bold bg-emerald-500/20 px-2 py-0.5 rounded border border-emerald-500/30">
                    Dupla Oficial • 5º Lugar (30,0% • 100% em dia)
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-950/60 border border-emerald-500/30 flex items-center gap-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-700 flex items-center justify-center font-black text-lg text-emerald-100 shadow-md">
                  PH
                </div>
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="px-1.5 py-0.5 rounded text-[9px] font-black bg-emerald-500/20 text-emerald-300 shrink-0">Parceiro</span>
                </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-3xl font-black text-slate-900 dark:text-white">30,0%</p>
            <span className="text-xs font-bold text-emerald-400 flex items-center">
              <TrendingUp className="w-3.5 h-3.5 mr-0.5" /> 5º Lugar
            </span>
          </div>
          <p className="text-[11px] text-slate-400">Dupla Oficial: Eduardo & Pedro • 5º Lugar (sem queda, sem pendências)</p>
        </div>
