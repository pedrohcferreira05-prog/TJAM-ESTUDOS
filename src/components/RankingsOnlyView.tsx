          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span className="text-[11px] text-emerald-400 font-semibold flex items-center gap-1 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
                    <CheckCircle2 className="w-3 h-3" /> Resultado Homologado
                  </span>
                </div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Tribunal de Justiça do Estado do Amazonas • Simulado Geral (80 Questões) & Desafio de Duplas
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-full sm:w-auto px-5 py-3 rounded-xl bg-gradient-to-r from-amber-500 via-amber-600 to-amber-700 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs uppercase tracking-wider shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2.5 transition-all cursor-pointer hover:shadow-amber-500/30 active:scale-[0.98] disabled:opacity-50 shrink-0"
              >
