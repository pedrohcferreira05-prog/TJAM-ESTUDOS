...
export const RankingsOnlyView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans selection:bg-amber-100 selection:text-amber-900">
      {/* Cabeçalho Institucional Oficial - Limpo e Responsivo */}
      <header className="relative w-full border-b border-slate-200 bg-white shadow-xs">
        {/* Linha de destaque no topo */}
        <div className="h-1 w-full bg-amber-500" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            {/* Bloco de Título e Brasão do TJAM */}
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-amber-500 text-slate-950 font-black shadow-xs flex items-center justify-center shrink-0">
            ...
            {/* Ação de Download com design limpo */}
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                className="w-full sm:w-auto px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs uppercase tracking-wider shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-[0.98] disabled:opacity-50 shrink-0"
              >
                <Download className="w-4 h-4 stroke-[2.5]" />
                <span>
                  {isGeneratingPdf ? 'Gerando Relatório...' : 'Baixar Relatório Oficial (PDF)'}
                </span>
              </button>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 flex-1 w-full space-y-6 sm:space-y-8">
        ...
        <section className="rounded-3xl bg-white border border-slate-200 p-5 sm:p-8 shadow-xs relative overflow-hidden">
          <div className="relative z-10 space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-slate-500">
                <span>Protocolo:</span>
                <span className="font-bold text-slate-800 bg-slate-100 px-2 py-0.5 rounded border border-slate-200">TJAM-2026-FINAL-80Q</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-sky-50/70 border border-sky-200 shadow-xs space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase tracking-wider text-sky-800 flex items-center gap-1.5">
                    <Award className="w-4 h-4 text-sky-600" /> Ranking Individual do Simulado
                  </span>
                  <span className="w-9 h-9 rounded-xl bg-sky-600 text-white font-black text-sm flex items-center justify-center shadow-xs">
                    2º
                  </span>
                </div>
                <div className="space-y-1">
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl sm:text-4xl font-black text-slate-900">83,8%</span>
                    <span className="text-xs font-bold text-emerald-700 font-mono bg-emerald-100 px-2 py-0.5 rounded">67 / 80 Acertos</span>
                  </div>
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-amber-50/70 border border-amber-200 shadow-xs space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase tracking-wider text-amber-900 flex items-center gap-1.5">
                    <Users className="w-4 h-4 text-amber-600" /> Ranking das Duplas (Turma Geral)
                  </span>
                ...
                <div className="space-y-1">
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl sm:text-4xl font-black text-slate-900">30,0%</span>
                    <span className="text-xs font-bold text-amber-800 font-mono bg-amber-100 px-2 py-0.5 rounded">Dupla Oficial</span>
                  </div>
            ...
            {/* Badges de Auditoria */}
            <div className="flex flex-wrap items-center gap-2.5 pt-2 text-xs text-slate-600">
              <span className="flex items-center gap-1 bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200 font-medium">
                <BarChart3 className="w-3.5 h-3.5 text-amber-600" />
                <strong className="text-slate-800">14 Duplas / Participantes</strong> avaliados
              </span>
              <span className="flex items-center gap-1 bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200 font-medium">
                <Flame className="w-3.5 h-3.5 text-sky-600" />
                <strong className="text-slate-800">22 Alunos no Simulado Individual</strong>
              </span>
              <span className="flex items-center gap-1 bg-rose-50 px-3 py-1.5 rounded-xl border border-rose-200 text-rose-800 font-medium">
        ...
        <section className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-xs rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 shadow-xs"
            />
          </div>
        </section>
        ...
        >
          ...
          {(activeTab === 'both' || activeTab === 'duplas') && (
            <div className="p-5 sm:p-6 rounded-3xl bg-white border border-slate-200 shadow-xs space-y-6">
                ...
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-slate-500 truncate">
                      Eduardo & Pedro: 5º lugar geral com 30,0%
                    </p>
                  </div>
                </div>
                <span className="text-[11px] font-mono font-bold text-amber-800 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-200 shrink-0">
                  {classifiedDuplas.length} Classificados
                </span>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> Duplas Classificadas ({classifiedDuplas.length})
                </h4>
                  ...
                  {classifiedDuplas.map((item, idx) => (
                    <div
                      ...
                      className={`p-3.5 rounded-2xl border flex items-center justify-between gap-3 text-xs transition-all ${
                        item.isUser
                          ? 'bg-amber-50/80 border-amber-300 ring-1 ring-amber-200 shadow-xs'
                        ...
                        <span
                          className={`w-7 h-7 rounded-xl text-xs font-black flex items-center justify-center shrink-0 ${
                            item.isUser
                              ...
                              : typeof item.rank === 'number' && item.rank <= 3
                ...
                <div className="pt-4 border-t border-slate-100 space-y-2.5">
                  <div className="flex items-center justify-between">
                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-rose-700 flex items-center gap-1.5">
                      <Ban className="w-3.5 h-3.5 text-rose-600" /> Duplas Desclassificadas • Nota Zero ({disqualifiedDuplas.length})
                    </h4>
                    <span className="text-[10px] font-bold uppercase text-rose-700 bg-rose-50 border border-rose-200 px-2 py-0.5 rounded-md">
                      0,0%
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    {disqualifiedDuplas.map((item, idx) => (
                      <div
                        ...
                        className="p-3.5 rounded-2xl border border-rose-200 bg-rose-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
                      >
                        <div className="flex items-start gap-3">
                          <span className="px-2 py-1 rounded-lg text-[10px] font-black bg-rose-600 text-white shrink-0 uppercase tracking-wider">
                            DESC
                          </span>
                          <div>
                            <div className="flex items-center gap-2 flex-wrap">
                              <span className="font-bold text-rose-950 text-sm">{item.name}</span>
                        ...
                        <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                          <span className="font-mono font-black text-xs text-rose-800 bg-rose-100 px-2.5 py-1 rounded-lg border border-rose-200">
                            Nota: 0,0%
                          </span>
                        </div>
                      </div>
          ...
          {(activeTab === 'both' || activeTab === 'individual') && (
            <div className="p-5 sm:p-6 rounded-3xl bg-white border border-slate-200 shadow-xs space-y-6">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 gap-2">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-slate-500 truncate">
                      Eduardo Mateus: 2º lugar com 83,8% (67 de 80)
                    </p>
                  </div>
                </div>
                <span className="text-[11px] font-mono font-bold text-sky-800 bg-sky-50 px-2.5 py-1 rounded-lg border border-sky-200 shrink-0">
                  {classifiedIndividual.length} Classificados
                </span>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-sky-600" /> Candidatos Classificados ({classifiedIndividual.length})
                </h4>
              ...
              {/* Bloco de 5 Alunos Desclassificados com Nota Zero */}
              {disqualifiedIndividual.length > 0 && (
                <div className="pt-4 border-t border-slate-100 space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-rose-700 flex items-center gap-1.5">
                      <AlertTriangle className="w-3.5 h-3.5 text-rose-600" /> Candidatos Desclassificados ({disqualifiedIndividual.length})
                    </h4>
                    <span className="text-[10px] font-bold uppercase text-rose-700 bg-rose-50 border border-rose-200 px-2 py-0.5 rounded-md">
                      0 Acertos • 0,0%
                    </span>
                      ...
                      return (
                        <div
                          ...
                          className={`p-3.5 rounded-2xl border transition-all ${
                            isPedro
                              ? 'border-rose-400 bg-rose-100/70 ring-1 ring-rose-300 shadow-xs'
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <div className="flex items-center gap-2 flex-wrap">
                                <span className={`font-bold text-sm ${isPedro ? 'text-rose-950 underline decoration-rose-500 decoration-2' : 'text-rose-900'}`}>
                                  {item.name}
                                </span>
                                <span
                          ...
                          <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                            <span className="font-mono font-bold text-[11px] text-rose-800 bg-rose-100 px-2 py-1 rounded-lg border border-rose-200">
                              0/80 Acertos
                            </span>
                            <span className="font-mono font-black text-xs text-white bg-rose-600 px-2.5 py-1 rounded-lg shadow-xs">
                              0,0%
                            </span>
                          </div>
                        </div>
        ...
        <section className="p-5 sm:p-6 rounded-3xl bg-white border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px]">
                Classificações auditadas e registradas com 14 duplas/participantes e 22 candidatos individuais.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            onClick={handleDownloadPdf}
            disabled={isGeneratingPdf}
            className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer border border-slate-200 shadow-xs"
          >
      ...
      {showBackToTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 px-3.5 py-2.5 rounded-2xl bg-white text-slate-800 border border-slate-200 shadow-lg hover:bg-slate-50 transition-all flex items-center gap-2 text-xs font-bold cursor-pointer"
