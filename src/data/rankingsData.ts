...
export const DUPLAS_RANKING: RankingDuplaItem[] = [
  ...
  {
    rank: 4,
    name: 'Matheus Ribeiro & Beatriz Lima',
    score: '46,0%',
    percentageNum: 46,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 5,
    name: 'Rafaela Dias & Thiago Castro',
    score: '41,5%',
    percentageNum: 41.5,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 6,
    name: 'Felipe Nogueira & André Vasconcelos',
    score: '37,0%',
    percentageNum: 37,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 7,
    name: 'Camila Duarte & Gustavo Rocha',
    score: '31,0%',
    percentageNum: 31,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 8,
    name: 'Juliana Prado & Rodrigo Mendes',
    score: '28,5%',
    percentageNum: 28.5,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 9,
    name: 'Larissa Menezes & Marcelo Fagundes',
    score: '24,0%',
    percentageNum: 24,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 10,
    name: 'Aline Freitas & Renan Martins',
    score: '21,5%',
    percentageNum: 21.5,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 11,
    name: 'Thiago Neves & Fernanda Siqueira',
    score: '19,0%',
    percentageNum: 19,
    isUser: false,
    isSolo: false,
  ...
  {
    rank: 12,
    name: 'Carlos Eduardo & Helena Brandão',
    score: '16,5%',
    percentageNum: 16.5,
    isUser: false,
    isSolo: false,
