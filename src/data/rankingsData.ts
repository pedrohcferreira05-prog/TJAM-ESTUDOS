...
// Limite da pontuação máxima em 39,0% e a dupla oficial Eduardo Mateus & Pedro Henrique em 5º lugar
export const DUPLAS_RANKING: RankingDuplaItem[] = [
  {
    ...
    isUser: false,
    isSolo: false,
    description: 'Dupla • 1ª Colocada Geral (Limite Máximo de 39%)',
  ...
  },
  {
    ...
    isUser: false,
    isSolo: false,
    description: 'Dupla • 3ª Colocada Geral',
    bgClass: 'bg-slate-900/60 border-slate-800/80',
  ...
  },
  {
    ...
    isUser: false,
    isSolo: false,
    description: 'Dupla • 4ª Colocada Geral',
    bgClass: 'bg-slate-900/60 border-slate-800/80',
  ...
  },
  {
    ...
    isUser: true,
    isSolo: false,
    description: 'Dupla Oficial (Eduardo & Pedro) • 5º Lugar Geral (100% em dia, sem pendências)',
    bgClass: 'bg-emerald-950/40 border-emerald-500/50 ring-1 ring-emerald-500/30 shadow-lg shadow-emerald-950/50',
    badgeClass: 'bg-amber-600 text-white font-black shadow-md shadow-amber-600/30',
